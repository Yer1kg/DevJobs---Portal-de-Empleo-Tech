...
export function Results() {
  ...
  const [techFilter, setTechFilter] = useState('');import { useEffect, useState } from 'react'; 
import { Link, useLocation } from 'react-router-dom';
import { SearchBar } from '../components/SearchBar';
import { useAuth } from '../context/AuthContext';
import { useJobs } from '../context/JobsContext';
    ...
    <main className="bg-dark" style={{ minHeight: '100vh', paddingBottom: '60px' }}>
      ...
      <div className="container" style={{ marginTop: '-35px' }}>
        ...
        <div className="filter-pills-container">
          ...
          {/* FIX REALIZADO AQUÍ: Valores ajustados a los datos guardados en la BD */}
          <select 
            className="pill-button" 
      ...
      <div className="container" style={{ marginTop: '20px', paddingBottom: '40px' }}>
        <section className="jobs-list-layout">
          ...
          {currentJobs.map((job) => {
            ...
            // Comprobación estricta de que el usuario tenga rol activo de empresa y sea el creador
            ...
            return (
              <article key={job.id} className="row-job-card">
                ...
                {/* Bloque Derecho: Acciones Simplificadas */}
                <div className="job-card-actions-side">
                  ...
                  {/* Botón Guardar (Para candidatos o trabajadores) */}
                  ...
                  {/* Acciones para la Empresa creadora (Sólo si su rol activo es empresa) */}
                  {isEmpresaOwner && (
